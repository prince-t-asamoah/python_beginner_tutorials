...
def dos2unix(source_file: str, dest_file: str):
    ...
    """
    # Info: Could add file existence checking and file overwriting
    # protection
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dest_file', help='Location of dest file (default: source_file appended with `_unix`)', default=None)
    
    # Parse the args (argparse automatically grabs the values from
    # sys.argv)
    args = parser.parse_args()
    source_file = args.source_file
    destination_file = args.dest_file
    ...
    if destination_file is None:
        ...
        destination_file = f'{file_path}_unix{file_extension}'
